      ...
      <Header containerStyle={{backgroundColor: '#040A19'}}>
        ...
        <EditProfilePageIcon
          onPress={() => {
                          ...
                          this.state.user && `https://res.cloudinary.com/dwnyawluh/image/facebook/q_70/${this.state.user.userId}.png`,
          ...
          <TouchableOpacity onPress={() => {
            ...
            <Image
              ...
              source={{uri: this.state.currentPic
                            || `https://res.cloudinary.com/dwnyawluh/image/facebook/q_70/${this.props.user && this.props.user.userId}.png`}}
              />
          </TouchableOpacity>
        </Animatable.View>
      );
