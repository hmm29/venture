    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity
          ...
          <Icon
            name={"ion|" + (this.props.selected ? "checkmark-circled" : (this.props.showChevronWhenDisabled
                        && !!this.props.showChevronWhenDisabled[0] ? "ios-arrow-"+(this.props.showChevronWhenDisabled
                        && this.props.showChevronWhenDisabled[1])  : "record"))}
